...
```
3. [Download](https://github.com/jxhuang0508/CVRN/releases/tag/cityIL) the converted instance labels and put the two instance label files of cityscapes ('instancesonly_gtFine_train.json' and 'instancesonly_gtFine_val.json') under 'CVRN/UPSNet/data/cityscapes/annotations_7cls'.

4. [Download](https://github.com/jxhuang0508/CVRN/releases/tag/synIL) the SYNTHIA instance label file ('instancesonly_train.json') and put it under 'CVRN/UPSNet/data/synthia_crop640/annotations_7cls_filtered'.
