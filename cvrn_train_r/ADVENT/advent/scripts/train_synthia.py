...
from advent.model.deeplab_vgg import DeeplabVGG
...
def main():
    ...
    elif cfg.TRAIN.MODEL == 'DeepLab_VGG':
        model = DeeplabVGG(num_classes=cfg.NUM_CLASSES, vgg16_caffe_path=cfg.TRAIN.RESTORE_FROM, pretrained=True)
    else:
